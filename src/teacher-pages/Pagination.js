...
const Pagination = ({pages, setCurrentPage, currentTeachers, sortedTeachers}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentTeachers.length}</b> out of <b>{sortedTeachers.length}</b> entries</div>
